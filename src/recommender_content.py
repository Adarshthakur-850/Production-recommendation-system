...
class ContentRecommender:
    ...
    def fit(self, df):
        ...
        self.df_products = (
            df[["product_id", "product_name", "category", "description"]]
            .drop_duplicates("product_id")
            .reset_index(drop=True)
        )
        # Combine features
        self.df_products["soup"] = (
            self.df_products["description"] + " " + self.df_products["category"]
        )
        ...
        self.indices = pd.Series(
            self.df_products.index, index=self.df_products["product_id"]
        ).drop_duplicates()
